            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              {phenomenon.period && (
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  ...
                  <p className="text-green-800 font-medium">{phenomenon.period.name}</p>
                  {phenomenon.period.startDate && phenomenon.period.endDate && (
                    <p className="text-green-600 text-sm mt-1">
                      {(() => {
                        const startDate = new Date(phenomenon.period.startDate);
                        const endDate = new Date(phenomenon.period.endDate);
